...
function Login() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center">
      <div className="flex flex-col gap-8 rounded-md border border-gray-primary bg-white p-4 shadow-xl">
        <div className="flex w-80 flex-col items-center">
          <UserGroupIcon className="size-20 text-blue-primary" />
          ...
          <div>
            ...
            <div className="flex flex-col items-center text-sm">
              <div>
                ...
                <a
                  className="font-semibold text-blue-primary hover:text-blue-500"
                  href="#"
                >
                  Sign up
                </a>
